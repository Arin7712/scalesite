...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10 max-h-screen"
      ref={containerRef}
    >
      <div ref={ref} className="max-w-7xl mx-auto pb-20 max-h-screen overflow-y-scroll hide-scrollbar">
        {data.map((item, index) => {
